...
const Logo = () => (
  <svg width="26" height="26" viewBox="0 0 32 32" fill="none">
    <path d="M16 4c-3 0-7 3-7 8s7 12 7 12 7-7 7-12-4-8-7-8z" fill="#c46db0" opacity="0.9" />
    <path d="M10 12c-2-1.5-5 0-5 4s3 6 5 7" stroke="#c46db0" strokeWidth="1.6" strokeLinecap="round" fill="none" />
    <path d="M22 12c2-1.5 5 0 5 4s-3 6-5 7" stroke="#c46db0" strokeWidth="1.6" strokeLinecap="round" fill="none" />
  </svg>
);
