export const JOURNEY_CONFIG = {
  pregnant: {
    ...
    quickActions: [
      ["/icons/scan.png", "Scan Drug", "health", "#093d6d", "#ffff"],
      ["/icons/nutrition.png", "Nutrition", "nutrition", "var(--sgl)", "#ffff"],
      ["/icons/kicks.png","Kicks","kicks","#4e26bb","#fdeeec"],
      ["/icons/sos.png","SOS",null,"#eb290f","#ffff"]
    ],
    showAlert: true,
  },
  conceive: {
